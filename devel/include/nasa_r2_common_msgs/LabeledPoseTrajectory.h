// Generated by gencpp from file nasa_r2_common_msgs/LabeledPoseTrajectory.msg
// DO NOT EDIT!


#ifndef NASA_R2_COMMON_MSGS_MESSAGE_LABELEDPOSETRAJECTORY_H
#define NASA_R2_COMMON_MSGS_MESSAGE_LABELEDPOSETRAJECTORY_H
...
{
  typedef LabeledPoseTrajectory_<ContainerAllocator> Type;
  ...
  typedef boost::shared_ptr< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> const> ConstPtr;

}; // struct LabeledPoseTrajectory_

typedef ::nasa_r2_common_msgs::LabeledPoseTrajectory_<std::allocator<void> > LabeledPoseTrajectory;

typedef boost::shared_ptr< ::nasa_r2_common_msgs::LabeledPoseTrajectory > LabeledPoseTrajectoryPtr;
typedef boost::shared_ptr< ::nasa_r2_common_msgs::LabeledPoseTrajectory const> LabeledPoseTrajectoryConstPtr;
...
{
ros::message_operations::Printer< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> >
{
  ...
  static const char* value(const ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6859ade925296749ULL;
  static const uint64_t static_value2 = 0xb6e37b0f7d35911aULL;
};

template<class ContainerAllocator>
struct DataType< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nasa_r2_common_msgs::LabeledPoseTrajectory_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // NASA_R2_COMMON_MSGS_MESSAGE_LABELEDPOSETRAJECTORY_H
