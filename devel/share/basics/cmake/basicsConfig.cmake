...
if("TRUE" STREQUAL "TRUE")
  set(basics_SOURCE_PREFIX /home/sketchc89/rosbook/src/basics)
  set(basics_DEVEL_PREFIX /home/sketchc89/rosbook/devel)
  set(basics_INSTALL_PREFIX "")
  set(basics_PREFIX ${basics_DEVEL_PREFIX})
else()
  set(basics_SOURCE_PREFIX "")
  set(basics_DEVEL_PREFIX "")
  set(basics_INSTALL_PREFIX /home/sketchc89/rosbook/install)
...
if(NOT "/home/sketchc89/rosbook/devel/include " STREQUAL " ")
  set(basics_INCLUDE_DIRS "")
  set(_include_dirs "/home/sketchc89/rosbook/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sketchc89/rosbook/src/basics/${idir}'.  Ask the maintainer 'sketchc89 <sketchc89@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sketchc89/rosbook/devel/lib;/home/sketchc89/rosbook/devel/lib;/opt/ros/kinetic/lib)
