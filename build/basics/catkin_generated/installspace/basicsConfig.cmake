...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sketchc89/rosbook/install/${idir}'.  Ask the maintainer 'sketchc89 <sketchc89@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sketchc89/rosbook/install/lib;/home/sketchc89/rosbook/devel/lib;/opt/ros/kinetic/lib)
